...
export interface YAMLcategoriesBase {
  ID?: number;
  Title?: string;
  YAMLcategory?: string;
  YAMLsubcategory?: string;
...
export interface YAMLcategoriesRead extends YAMLcategoriesBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}

export interface YAMLcategoriesWrite extends YAMLcategoriesBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}
